...
| **Runtime** | Bun ≥ 1.1 |
| **Konténer** | Docker (Bun build → nginx serve) |
...
| Döntés | Indoklás |
|---|---|
| **Bun** (nem Node) | Gyorsabb package manager, natív TypeScript/JSX, alacsonyabb memóriaigény |
...
| Csomag | Verzió | Cél |
|---|---|---|
| `bun` | ≥ 1.1 | JavaScript/TypeScript runtime + package manager |
